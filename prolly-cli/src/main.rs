...
use prolly_core::{garbage_collect, BlockStore, CachedFSBlockStore, ProllyTree, TreeCursor, Repo, diff, DiffEvent, PullItemType, Remote};
...
fn main() -> anyhow::Result<()> {
    ...
    match cli.command {
        ...
        Commands::Import {
            ...
            let opened_repo = open_repo(&repo, cache_size)?;
            sqlite_import::import_sqlite(&opened_repo, &repo, &sqlite_path, batch_size, verbose)?;
        }
        Commands::Gc {
            repo,
            dry_run,
